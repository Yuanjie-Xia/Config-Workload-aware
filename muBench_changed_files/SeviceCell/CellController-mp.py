...
from flask import Flask, Response, json, make_response, request, copy_current_request_context
    ...
    def mission():
        ...
        try:
            ...
            if len(my_service_mesh) > 0:
                if len(trace) > 0:
                    service_error_dict, ext_response = run_external_service(
                        my_service_mesh,
            ...
            response_holder["response"] = make_response(json.dumps({"message": "Internal error"}), 500)
